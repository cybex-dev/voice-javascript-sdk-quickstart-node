(function (root) {
    var bundle = function () {
        ...
        6: [function (require, module, exports) {
            ...
            var Call = function (_super) {
                ...
                function Call(config, options) {
                    ...
                    _this._onAnswer = function (payload) {
                        ...
                        _this.emit("status", Call.CallStatus.Answer)
                    };
                    _this._onCancel = function (payload) {
                        ...
                        if (_this.parameters.CallSid === callsid) {
                            ...
                            _this.emit("status", Call.CallStatus.Closed);
                            _this.emit("cancel");
                    ...
                    _this._onMediaFailure = function (type) {
                        ...
                        if (type === LowBytes && isIceDisconnected || type === ConnectionDisconnected && hasLowBytesWarning || isEndOfIceCycle) {
                            ...
                            _this.emit("status", Call.CallStatus.Reconnecting);
                    ...
                    _this._onMediaReconnected = function () {
                        ...
                        if (_this._signalingStatus === Call.State.Open) {
                            ...
                            _this.emit("status", Call.CallStatus.Reconnected)
                        }
                    };
                    _this._onMessageReceived = function (payload) {
                        var callsid = payload.callsid, content = payload.content, contenttype = payload.contenttype,
                            messagetype = payload.messagetype, voiceeventsid = payload.voiceeventsid;
                        if (_this.parameters.CallSid !== callsid) {
                    ...
                    _this._onRinging = function (payload) {
                        ...
                        _this.emit("status", Call.CallStatus.Ringing);
            ...
            (function (Call) {
                ...
                (function (CallStatus) {
                    ...
                    CallStatus["Reconnected"] = "reconnected";
                    CallStatus["Ringing"] = "ringing";
                    CallStatus["Rejected"] = "rejected";
                    CallStatus["Answer"] = "answer"
                })(CallStatus = Call.CallStatus || (Call.CallStatus = {}));
                var FeedbackIssue;
            ...
            var Device = function (_super) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        play = ((_a = this.audio) === null || _a === void 0 ? void 0 : _a.incoming()) && !wasBusy ? function () {
                                ...
                                case 1:
                                    ...
                                    options = Object.assign({
                                        ...
                                        shouldPlayDisconnect: function () {
                                            var _a;
                                            return (_a = _this.audio) === null || _a === void 0 ? void 0 : _a.disconnect()
                                        },
                ...
                Device.prototype._showIncomingCall = function (call, play) {
                    ...
                    return Promise.race([play(), new Promise(function (resolve, reject) {
                        ...
                        call.emit("status", call_1.default.State.Ringing)
                    })
                };
            ...
            (function (MalformedRequestErrors) {
                var MalformedRequestError = function (_super) {
                    ...
                    function MalformedRequestError(messageOrError, error) {
                        var _this = _super.call(this, messageOrError, error) || this;
                        _this.causes = ["Invalid content or MessageType passed to sendMessage method."];
                        _this.code = 31100;
                        _this.description = "The request had malformed syntax.";
                        _this.explanation = "The request could not be understood due to malformed syntax.";
                        _this.name = "MalformedRequestError";
                        _this.solutions = ["Ensure content and MessageType passed to sendMessage method are valid."];
            ...
            (function (AuthorizationErrors) {
                var RateExceededError = function (_super) {
                    ...
                    function RateExceededError(messageOrError, error) {
                        ...
                        _this.solutions = ["Ensure message send rate does not exceed authorized limits."];
                ...
                var PayloadSizeExceededError = function (_super) {
                    ...
                    function PayloadSizeExceededError(messageOrError, error) {
                        var _this = _super.call(this, messageOrError, error) || this;
                        _this.causes = ["The payload size of Call Message Event exceeds the authorized limit."];
                        _this.code = 31209;
                        ...
                        _this.solutions = ["Reduce payload size of Call Message Event to be within the authorized limit and try again."];
        ...
        17: [function (require, module, exports) {
            ...
            exports.PreflightTest = PreflightTest
        }, {"../call": 6, "../constants": 7, "../device": 9, "../errors": 12, "../rtc/stats": 29, events: 53}],
        ...
        }, {"./constants": 7, "./errors": 12, "./log": 15, "./wstransport": 37, events: 53}],
        ...
        }, {"../log": 15, "../util": 35, "./sdp": 28, "rtcpeerconnection-shim": 61}],
        ...
        }, {"./asyncQueue": 4, "./errors": 12, "@twilio/audioplayer": 41}],
        ...
        }, {"./errors": 12, "./rtc/mos": 25, "./rtc/stats": 29, "./util": 35, events: 53}],
        ...
        }, {"./errors": 12, "./log": 15, backoff: 45, events: 53, ws: 1}],
        ...
        }, {"./Deferred": 39, "./EventTarget": 40, "babel-runtime/regenerator": 44}],
        ...
        45: [function (require, module, exports) {
            ...
            "./lib/backoff": 46,
            "./lib/function_call.js": 47,
            "./lib/strategy/exponential": 48,
            "./lib/strategy/fibonacci": 49
        }],
        ...
        }, {"./backoff": 46, "./strategy/fibonacci": 49, events: 53, precond: 57, util: 65}],
        ...
        }, {"./strategy": 50, precond: 57, util: 65}],
        ...
        56: [function (require, module, exports) {
            (function () {
                var crypt = require("crypt"), utf8 = require("charenc").utf8, isBuffer = require("is-buffer"),
                    bin = require("charenc").bin, md5 = function (message, options) {
                        ...
                        var m = crypt.bytesToWords(message), l = message.length * 8, a = 1732584193, b = -271733879,
        ...
        }, {charenc: 51, crypt: 52, "is-buffer": 54}],
        ...
        }, {"./support/isBuffer": 64, _process: 60, inherits: 63}]
    }, {}, [3]);
    var Voice = bundle(3);
    if (typeof define === "function" && define.amd) {
        define([], function () {
