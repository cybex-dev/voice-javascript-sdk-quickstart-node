(function(root) {
  var bundle = function() {
      ...
      var Call = function(_super) {
        ...
        function Call(config, options) {
          ...
          _this._onAck = function(payload) {
            var acktype = payload.acktype, callsid = payload.callsid,
          ...
          _this._onCancel = function(payload) {
            ...
            if (_this.parameters.CallSid === callsid) {
              ...
              _this.emit('status', _this._status);
              _this.emit('cancel');
          ...
          _this._onMessageReceived = function(payload) {
            var callsid = payload.callsid, content = payload.content,
          ...
          _this._onSignalingReconnected = function() {
            ...
            if (_this._mediaStatus === Call.State.Open) {
              ...
              _this.emit('reconnected');
              _this._status = Call.State.Open;
              this.emit('status', _this._status);
            }
          };
        ...
        Call.prototype.sendMessage = function(message) {
          var content = message.content, contentType = message.contentType,
    ...
    28: [function(require, module, exports) {
      ...
      function getPreferredCodecInfo(sdp) {
        var _ref = /a=rtpmap:(\d+) (\S+)/m.exec(sdp) || [null, '', ''],
          _ref2 = _slicedToArray(_ref, 3), codecId = _ref2[1],
          codecName = _ref2[2];
        var regex = new RegExp('a=fmtp:' + codecId + ' (\\S+)', 'm');
        var _ref3 = regex.exec(sdp) || [null, ''],
          _ref4 = _slicedToArray(_ref3, 2), codecParams = _ref4[1];
    ...
    56: [function(require, module, exports) {
      (function() {
        var crypt = require('crypt'), utf8 = require('charenc').utf8,
          isBuffer = require('is-buffer'), bin = require('charenc').bin,
          md5 = function(message, options) {
            ...
            var m = crypt.bytesToWords(message), l = message.length * 8,
